...
public class AdapterC extends RecyclerView.Adapter<AdapterC.ViewHolder> {
    ...
    int m=1;
    Context contextC;
    List<ModelClassC> countrylist;

    public AdapterC(Context context, List<ModelClassC> countrylist) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View view= LayoutInflater.from(contextC).inflate(R.layout.layout_item_covid,null,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ModelClassC modelClass = countrylist.get(position);
        if (m == 1) {
