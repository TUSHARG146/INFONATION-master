...
public class MainActivityWeather extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(MainActivityWeather.this, ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
            if (ActivityCompat.shouldShowRequestPermissionRationale(MainActivityWeather.this, ACCESS_FINE_LOCATION)){

                ActivityCompat.requestPermissions(MainActivityWeather.this,
        ...
        client.getLastLocation().addOnSuccessListener(MainActivityWeather.this, new OnSuccessListener<Location>() {
            @Override
        ...
        switch (requestCode) {
            case 1: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    if (ActivityCompat.checkSelfPermission(MainActivityWeather.this,
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.id_otherCity:
                Intent intent=new Intent(MainActivityWeather.this,CitySearch.class);
    ...
    {
        super.onBackPressed();
        Intent intx = new Intent(MainActivityWeather.this,dashboard.class);
        startActivity(intx);
        finish();
    }
